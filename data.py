...
CHARMS_POOL = [
    ...
    {'name': 'Homebrew Hazard', 'rarity': 'Rare', 'cost': 7, 'desc': 'Random encounter: 1/6 chance for bonus charm.', 'type': 'random_event'},
    ...
    {'name': 'Sorcerer\'s Surge', 'rarity': 'Legendary', 'cost': 10, 'desc': 'Random +2x to +5x mult on kinds (rolled once per turn).', 'type': 'surge_random', 'range': [2, 5]},
    ...
    {'name': 'Burglar Bag', 'rarity': 'Rare', 'cost': 6, 'desc': 'When blind selected, +3 hands but lose all discards.', 'type': 'burglar_bonus', 'value': 3, 'lose_discards': True},
